...
const cookies = require('../dist/weapp-cookie.umd');
const setCookieStr =
  'EGG_SESSION=cQgFSy2NnOAAqWu7YUVVEoFWkf2YxXL1pi4GYPBl9ieUPI_YSy6LBvs7lsxB52cZ; domain=baidu.com; path=/; expires=Fri, 27 Jul 2022 04:02:51 GMT; httponly, dwf_sg_task_completion=False; expires=Sat, 25-Aug-2022 04:04:04 GMT; Max-Age=2592000; Path=/; secure;, PSINO=7; domain=.baidu.com; path=/,prod_crm_session=gBz4cg45F7A5TwRuSNgOw5xSRilpiec9Mht7bS9a; expires=Thu, 26-Jul-2022 06:14:05 GMT; Max-Age=2592000; path=/; domain=.taobao.com; httponly';
...
describe('weapp-cookies.js', () => {
  ...
  it('cookie.maxAge=0', () => {
    const setCookieMaxage = 'PSINO=7; Max-Age=0; path=/; domain=.baidu.com; httponly';
    cookies.setResponseCookies(setCookieMaxage, 'baidu.com');
    let result = cookies.has('PSINO', 'baidu.com');
